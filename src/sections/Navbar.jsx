...
export default function Navbar({
  ...
  const resolvedScrolled = typeof isScrolled === 'boolean' ? isScrolled : localScrolled;
  const resolvedIsMobile = typeof isMobile === 'boolean' ? isMobile : localIsMobile;

  const resolvedMobileMenuOpen =
    typeof mobileMenuOpen === 'boolean' ? mobileMenuOpen : localMobileMenuOpen;

  const resolvedSetMobileMenuOpen =
    typeof setMobileMenuOpen === 'function' ? setMobileMenuOpen : setLocalMobileMenuOpen;

  const closeMobileMenu = () => {
    resolvedSetMobileMenuOpen(false);
  };
    ...
    <>
      ...
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          resolvedScrolled
            ? resolvedIsMobile
              ? 'bg-[#0A0E12]/95 shadow-md shadow-black/40'
              : 'bg-[#0A0E12]/80 backdrop-blur-md shadow-lg shadow-black/30 border-b border-[#2DD4BF]/25'
            : 'bg-transparent'
        }`}
      >
        <div className="max-w-7xl mx-auto px-6 py-3 lg:py-4">
          <div className="flex items-center justify-between">
                ...
                <span className="flex items-center">
                  <span className="relative inline-block w-[2.4em] h-[2.4em]">
                    <img
                      ...
                      style={{
                        animation:
                          'logo-tech-pulse 4s ease-in-out infinite, glow-mint 10s ease-in-out infinite',
                        '--logo-anim':
                          'logo-tech-pulse 4s ease-in-out infinite, glow-mint 10s ease-in-out infinite',
                      }}
                    />
                  ...
                  {['l', 'e', 'x', 'u', 'r', 'a'].map((letter, index) => (
                    <span
                      ...
                      style={{
                        ...
                        animation: `glow-mint 10s ease-in-out infinite ${
                          (index + 1) * 0.05
                        }s`,
                        '--logo-anim': `glow-mint 10s ease-in-out infinite ${
                          (index + 1) * 0.05
                        }s`,
                      }}
                    >
            ...
            <div className="hidden md:flex items-center space-x-8">
              <button
                onClick={() => goToHomeSection('home')}
                className="text-[#5B6B7A] hover:text-[#EA580C] transition-colors duration-200 relative group"
              >
                Home
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#EA580C] group-hover:w-full transition-all duration-300" />
              </button>
              ...
              <button
                ...
                className="px-6 py-2 bg-gradient-to-r from-[#14B8A6] to-[#2DD4BF] text-[#06201C] font-bold rounded-lg hover:shadow-lg hover:shadow-[#2DD4BF]/40 transition-all duration-200"
              >
                Contact Us
              </button>
            </div>
            ...
            <button
              ...
              onClick={() => resolvedSetMobileMenuOpen(true)}
      ...
      {resolvedMobileMenuOpen && (
        <>
          ...
          <div className="fixed top-0 right-0 bottom-0 w-[85%] max-w-sm z-[70] md:hidden animate-slideInRight">
            <div className="absolute inset-0 bg-gradient-to-br from-[#080B0F]/95 via-[#10151B]/95 to-[#222B34]/95 backdrop-blur-2xl" />
            <div className="absolute inset-0 opacity-10">
              <div className="grid-pattern" />
            </div>
            <div className="absolute top-0 left-0 bottom-0 w-1 bg-gradient-to-b from-[#2DD4BF] via-[#F87171] to-[#222B34] shadow-lg shadow-[#2DD4BF]/50" />
            ...
            <div className="relative h-full flex flex-col">
              <div className="px-8 pt-8 pb-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  >
                    <span className="flex items-center">
                      <img
                        src="/plexxx.png"
                        alt="P"
                        className="w-[2em] h-[2em] object-contain inline-block"
                      />
                      {['l', 'e', 'x', 'u', 'r', 'a'].map((letter, index) => (
                        <span
                          key={index}
                          className="inline-block text-[#F2F9FF]"
                          style={{ marginLeft: index === 0 ? '-0.5em' : '0' }}
                        >
                          {letter}
                        </span>
                      ))}
                  ...
                  >
                    <X
                      size={20}
                      className="text-[#9FB6B2] group-hover:text-[#2DD4BF] transition-colors"
                    />
                  </button>
                </div>

                <p className="text-sm text-[#9FB6B2] font-light tracking-wide">
                  Growth Systems
                </p>
              </div>
              ...
              <div className="flex-1 px-6 py-8 space-y-3 overflow-y-auto">
                ...
                >
                  <div className="relative px-6 py-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 hover:border-[#2DD4BF]/50 transition-all duration-300 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-[#2DD4BF]/0 via-[#2DD4BF]/10 to-[#2DD4BF]/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    <div className="relative flex items-center justify-between">
                      <div>
                        <span className="block text-xl font-semibold text-[#F2F9FF] group-hover:text-[#2DD4BF] transition-colors duration-300">
                          Home
                        </span>
                        <span className="block text-xs text-[#9FB6B2] mt-1">
                          Welcome page
                        </span>
                      </div>
                      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#2DD4BF]/20 to-[#F87171]/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        <span className="text-[#2DD4BF] group-hover:translate-x-0.5 transition-transform duration-300">
                          →
                        </span>
                      </div>
                    </div>
                ...
                >
                  <div className="relative px-6 py-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 hover:border-[#F87171]/50 transition-all duration-300 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-[#F87171]/0 via-[#F87171]/10 to-[#F87171]/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    <div className="relative flex items-center justify-between">
                      <div>
                        <span className="block text-xl font-semibold text-[#F2F9FF] group-hover:text-[#F87171] transition-colors duration-300">
                          Services
                        </span>
                        <span className="block text-xs text-[#9FB6B2] mt-1">
                          What we offer
                      ...
                      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#F87171]/20 to-[#222B34]/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        <span className="text-[#F87171] group-hover:translate-x-0.5 transition-transform duration-300">
                          →
                        </span>
                      </div>
                    </div>
                ...
                >
                  <div className="relative px-6 py-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 hover:border-[#222B34]/50 transition-all duration-300 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-[#222B34]/0 via-[#222B34]/10 to-[#222B34]/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    <div className="relative flex items-center justify-between">
                      <div>
                        <span className="block text-xl font-semibold text-[#F2F9FF] group-hover:text-[#5EEAD4] transition-colors duration-300">
                          About
                        </span>
                        <span className="block text-xs text-[#9FB6B2] mt-1">
                          How we build
                      ...
                      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#222B34]/20 to-[#2DD4BF]/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        <span className="text-[#5EEAD4] group-hover:translate-x-0.5 transition-transform duration-300">
                          →
                        </span>
                      </div>
                    </div>
                ...
                >
                  <div className="relative px-6 py-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 hover:border-[#F97316]/50 transition-all duration-300 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-[#F97316]/0 via-[#F97316]/10 to-[#F97316]/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    <div className="relative flex items-center justify-between">
                      <div>
                        <span className="block text-xl font-semibold text-[#F2F9FF] group-hover:text-[#2DD4BF] transition-colors duration-300">
                          Our Team
              ...
              <div className="px-6 pb-8">
                <div className="relative rounded-2xl bg-gradient-to-br from-[#F97316] via-[#2DD4BF] to-[#5EEAD4] p-[2px] overflow-hidden group">
                  <div className="absolute inset-0 bg-gradient-to-r from-[#2DD4BF] via-[#F97316] to-[#2DD4BF] animate-gradient-shift" />
