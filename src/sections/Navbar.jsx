      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? (isMobile ? 'bg-[#0A0E12]/95 shadow-md shadow-black/40' : 'bg-[#0A0E12]/80 backdrop-blur-md shadow-lg shadow-black/30 border-b border-[#2DD4BF]/25') : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-6 py-3 lg:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center group cursor-pointer" onClick={() => goToHomeSection('home')}>
            ...
            <div className="hidden md:flex items-center space-x-8">
              <button onClick={() => goToHomeSection('home')} className="text-[#5B6B7A] hover:text-[#EA580C] transition-colors duration-200 relative group">
                Home
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#EA580C] group-hover:w-full transition-all duration-300"></span>
              </button>

              <button onClick={() => goToHomeSection('services')} className="text-[#5B6B7A] hover:text-[#EA580C] transition-colors duration-200 relative group">
                Solutions
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#EA580C] group-hover:w-full transition-all duration-300"></span>
              </button>
              ...
              <button onClick={() => goToHomeSection('about')} className="text-[#5B6B7A] hover:text-[#EA580C] transition-colors duration-200 relative group">
                About
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#EA580C] group-hover:w-full transition-all duration-300"></span>
              </button>

              <button onClick={() => goToHomeSection('team')} className="text-[#5B6B7A] hover:text-[#EA580C] transition-colors duration-200 relative group">
                Our Team
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#EA580C] group-hover:w-full transition-all duration-300"></span>
              </button>

              <button onClick={() => goToHomeSection('contact')} className="px-6 py-2 bg-gradient-to-r from-[#14B8A6] to-[#2DD4BF] text-[#06201C] font-bold rounded-lg hover:shadow-lg hover:shadow-[#2DD4BF]/40 transition-all duration-200">
                Contact Us
              </button>
            </div>
          ...
          <div className="fixed top-0 right-0 bottom-0 w-[85%] max-w-sm z-50 md:hidden animate-slideInRight">
            ...
            <div className="relative h-full flex flex-col">
              ...
              <div className="flex-1 px-6 py-8 space-y-3 overflow-y-auto">
                <button onClick={() => goToHomeSection('home')} className="group block relative w-full text-left">
                ...
                <button onClick={() => goToHomeSection('services')} className="group block relative w-full text-left">
                  <div className="relative px-6 py-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 hover:border-[#2DD4BF]/50 transition-all duration-300 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-[#2DD4BF]/0 via-[#2DD4BF]/10 to-[#2DD4BF]/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div className="relative flex items-center justify-between">
                      <div>
                        <span className="block text-xl font-semibold text-[#F2F9FF] group-hover:text-[#2DD4BF] transition-colors duration-300">Solutions</span>
                        <span className="block text-xs text-[#9FB6B2] mt-1">Homepage overview</span>
                      </div>
                      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#2DD4BF]/20 to-[#F87171]/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        <span className="text-[#2DD4BF] group-hover:translate-x-0.5 transition-transform duration-300">→</span>
                      </div>
                ...
                <button onClick={() => goToHomeSection('about')} className="group block relative w-full text-left">
                ...
                <button onClick={() => goToHomeSection('team')} className="group block relative w-full text-left">
                ...
                <button onClick={() => goToHomeSection('contact')} className="group block relative w-full text-left">
                  <div className="relative px-6 py-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 hover:border-[#2DD4BF]/50 transition-all duration-300 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-[#2DD4BF]/0 via-[#2DD4BF]/10 to-[#2DD4BF]/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div className="relative flex items-center justify-between">
                      <div>
